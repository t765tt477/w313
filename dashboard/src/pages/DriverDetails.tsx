...
import { Mail, Phone, MapPin, Truck, DollarSign, Star, CheckCircle, Clock, Edit, Trash2, Save, X } from 'lucide-react';
...
export default function DriverDetails() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'drivers' | 'orders' | 'users' | 'analytics' | 'settings' | 'admin-management'>('drivers');
  ...
  const fetchDriverDetails = async () => {
    try {
      ...
      const foundDriver = response.data.drivers.find((d: Driver) => d._id === id);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-row" dir="rtl">
      ...
      {/* Content */}
      <div className="w-full h-screen mx-auto p-6 overflow-y-auto">
